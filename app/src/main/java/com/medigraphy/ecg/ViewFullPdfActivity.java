...
public class ViewFullPdfActivity extends Activity implements OnPageChangeListener, OnLoadCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (path.exists()) {
            ...
            pdfPopup.fromFile(path)
                    ...
                    .scrollHandle(new DefaultScrollHandle(ViewFullPdfActivity.this))
                    .load();

        } else {
            Toast.makeText(ViewFullPdfActivity.this, "Pdf Not available ", Toast.LENGTH_SHORT).show();
        }

        imgClose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                startActivity(new Intent(ViewFullPdfActivity.this, SendReportViewActivity.class).putExtra("filename",fileName));
                finish();
            }
        });
